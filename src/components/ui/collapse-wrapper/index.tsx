...
function index() {
  return (
    <div className="collapse-wrapper">
      <Collapse title="What is Netflix?">
        <p>
      ...
      <Collapse title="How much does Netflix Cost?">
        <p>
          Watch Netflix on your smartphone, tablet, Smart TV, laptop, or streaming device,
          all for one fixed monthly fee. Plans range from USD3.99 to USD9.99 a month. No
          extra costs, no contracts.
        </p>
      </Collapse>
      <Collapse title="Where can I watch?">
      ...
      <Collapse title="How do I cancel?">
      ...
      <Collapse title="What can I watch on Netflix?">
      ...
      <Collapse title="Is Netflix good for kids?">
